...
* Copy required Syncfusion Angular 2 source component(s) from the below build location and add it in `src/ej` folder (For ex., consider the `dialog` component).
...
![](/Getting Started/Images/getting-started-output.png) 
