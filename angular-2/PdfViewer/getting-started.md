...
This section explains briefly about how to integrate a **PDF viewer** control in your application with **Angular 2**.
...
The code example for defining PDF viewer control in Angular2 is as follows,
