...
<p>The Essential JavaScript for Syncfusion Angular 2 components supports Angular 2 final release version <a href="http://angularjs.blogspot.in/2016/09/angular2-final.html">2.0.</a></p>
</div>
<br/>
...
@media all and (min-width: 406px) and (max-width: 699px) {
  .angular-version {
    line-height: 30px;
	min-height: 60px;
  }
