...
* Create `percentagetextbox.component.ts` model file inside the folder `src/app/percentagetextbox` and create percentagetextbox sample component using the below code example.
