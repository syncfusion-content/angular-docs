---
layout: post
title: Sorting with Grid widget for Syncfusion Essential
description: How to enable sorting and its functionalities in angular grid control
platform: angular
control: Grid
documentation: ug
api: /api/js/ejgrid
--- 
# Sorting with Grid widget for Syncfusion Essential
