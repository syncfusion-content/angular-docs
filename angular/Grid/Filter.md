...
You can enable menu filter by setting [`filterSettings.filterType`](https://help.syncfusion.com/api/js/ejgrid#members:filtersettings-filtertype "filterSettings.filterType") property as `menu`. 

There is an option to show or hide the additional filter options in the menu by setting [`showPredicate`](https://help.syncfusion.com/api/js/ejgrid#members:filtersettings-showpredicate "showPredicate") of [`filterSettings`](https://help.syncfusion.com/api/js/ejgrid#members:filtersettings "filterSettings") property as `true` or `false` respectively.
